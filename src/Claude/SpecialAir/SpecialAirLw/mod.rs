...
unsafe extern "C" fn effect_specialairlw(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        macros::EFFECT_FOLLOW(
            agent,
            Hash40::new("master_axe_slash_air_reverb"),
            Hash40::new("top"),
            0,
            6,
            0,
        ...
        macros::EFFECT_FOLLOW(
            agent,
            Hash40::new("master_axe_slash_air"),
            Hash40::new("top"),
            0,
            6,
            0,
    ...
    if macros::is_excute(agent) {
        ...
        macros::EFFECT_DETACH_KIND(agent, Hash40::new("master_axe_slash"), 2);
        macros::EFFECT_DETACH_KIND(agent, Hash40::new("master_axe_slash_reverb"), 2);
    }
...
pub fn install() {
    Agent::new("master")
        .effect_acmd("effect_specialairlw_switchgd", effect_specialairlw, Low)
        .install();
}
